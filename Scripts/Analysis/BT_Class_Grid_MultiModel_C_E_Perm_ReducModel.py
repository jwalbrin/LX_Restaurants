...
df_tpc_path = (main_path + 
               "ByClass/All_LX_Reviews_ByClass_%s_Train_%i_%s.pickle")

df_di_path = (main_path + 
               "%s_Train_%i_%s_Info.pickle")
...
reduc_mod_str = "Reduc_60_Clusters"
...
# load df_di
df_di_pickle = df_di_path % (topic_model_name, tr_split, reduc_mod_str)
